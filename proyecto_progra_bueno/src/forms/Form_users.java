...
----------------------------------------------------------------------------------*/
    ...
    private void initComponents() {
        ...
        btn_guardar.setBackground(new java.awt.Color(51, 255, 0));
        ...
        btn_nuevo.setBackground(new java.awt.Color(0, 255, 204));
        ...
        btn_buscar.setBackground(new java.awt.Color(0, 255, 204));
        ...
        btn_guardar2.setBackground(new java.awt.Color(51, 255, 51));
        ...
        btn_editar1.setBackground(new java.awt.Color(0, 255, 204));
    ...
    private void btn_guardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_guardarActionPerformed
        ...
        if(pass.equals(pass2) ){
           ...
           if(user.length()>0 && pass.length() > 0 && pass2.length() > 0){
                             ...
                             JOptionPane.showMessageDialog(this, "El usuario "+user+" ya existe");
                               ...
                               try {
                                   ...
                                   if(n > 0){
                                       ...
                                       JOptionPane.showMessageDialog(this,"Cliente guradado con éxito");
                                       cargarTabla();
                                   }
            ...
            JOptionPane.showMessageDialog(rootPane, "La contraseña no coinciden");
