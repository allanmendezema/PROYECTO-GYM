...
public class Form_clientes extends JFrame {
      ...
      public Form_clientes() {
        ...
        this.txt_telefono.setDocument(new Validar(txt_telefono,8));
...
/*-----------------------------------------------------------------------------------------------------------------------------------------
 ...
 -------------------------------------------------------------------------------------*/
    ...
    private void initComponents() {
        ...
        panel_personales.setBackground(new java.awt.Color(0, 0, 0));
        ...
        btn_cancelar.setFont(new java.awt.Font("Verdana", 1, 16)); // NOI18N
        ...
        btn_siguiente.setBackground(new java.awt.Color(51, 255, 0));
        btn_siguiente.setFont(new java.awt.Font("Verdana", 1, 16)); // NOI18N
        ...
        btn_limpiar.setFont(new java.awt.Font("Verdana", 1, 16)); // NOI18N
        ...
        panel_membresia.setBackground(new java.awt.Color(0, 0, 0));
        ...
        lbl_dias.setForeground(new java.awt.Color(255, 255, 255));
        ...
        btn_siguiente2.setBackground(new java.awt.Color(0, 255, 0));
        btn_siguiente2.setFont(new java.awt.Font("Verdana", 1, 16)); // NOI18N
        ...
        btn_atras.setFont(new java.awt.Font("Verdana", 1, 16)); // NOI18N
        ...
        panel_membresia.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(476, 221, 110, 39));
        ...
        btn_limpiar42.setBackground(new java.awt.Color(255, 0, 0));
        btn_limpiar42.setFont(new java.awt.Font("Verdana", 1, 16)); // NOI18N
        ...
        panel_ficha.setBackground(new java.awt.Color(0, 0, 0));
        ...
        btn_siguiente3.setBackground(new java.awt.Color(51, 255, 0));
        btn_siguiente3.setFont(new java.awt.Font("Verdana", 1, 16)); // NOI18N
        ...
        btn_limpiar3.setBackground(new java.awt.Color(255, 0, 0));
        btn_limpiar3.setFont(new java.awt.Font("Verdana", 1, 16)); // NOI18N
        ...
        lbl_cadera.setForeground(new java.awt.Color(255, 255, 255));
        ...
        btn_atras2.setBackground(new java.awt.Color(255, 0, 0));
        btn_atras2.setFont(new java.awt.Font("Verdana", 1, 16)); // NOI18N
        ...
        panel_final.setBackground(new java.awt.Color(0, 0, 0));
        ...
        btn_atras_final.setBackground(new java.awt.Color(255, 51, 0));
        btn_atras_final.setFont(new java.awt.Font("Verdana", 1, 16)); // NOI18N
        ...
        panel_final.add(btn_atras_final, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 20, 100, 40));

        btn_guardar.setBackground(new java.awt.Color(0, 255, 0));
        btn_guardar.setFont(new java.awt.Font("Verdana", 1, 16)); // NOI18N
        ...
        panel_final.add(btn_guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 20, 100, 40));
        ...
        panel_final1.setBackground(new java.awt.Color(0, 0, 0));
