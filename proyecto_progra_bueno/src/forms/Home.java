...
/*---------------------------------------------------------
 ...
 ----------------------------------------------------------*/
    ...
    private void initComponents() {
        ...
        setTitle("GYM \"MENCHITO\"");
        setBounds(new java.awt.Rectangle(0, 0, 600, 0));
        setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        setFont(new java.awt.Font("Verdana", 0, 16)); // NOI18N
        setMinimumSize(new java.awt.Dimension(900, 598));
        setPreferredSize(new java.awt.Dimension(900, 600));
        getContentPane().setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        lbl_bienvenido1.setBackground(new java.awt.Color(255, 255, 255));
        lbl_bienvenido1.setFont(new java.awt.Font("Bodoni MT Black", 0, 64)); // NOI18N
        lbl_bienvenido1.setForeground(new java.awt.Color(255, 255, 0));
        lbl_bienvenido1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_bienvenido1.setText("GYM \"MENCHITO\"");
        getContentPane().add(lbl_bienvenido1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 680, 80));
        ...
        getContentPane().add(btn_clientes, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, 150, 150));
        ...
        getContentPane().add(btn_membresia, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 40, 30, -1));
        ...
        getContentPane().add(btn_buscar_cliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 360, -1, 160));
        ...
        getContentPane().add(btn_pago, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 160, 130, 150));
        ...
        getContentPane().add(btn_buscar_membresia, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 360, 170, 160));
        ...
        getContentPane().add(btn_membresia1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 160, 160, 150));

        lbl_result_tipo.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        lbl_result_tipo.setForeground(new java.awt.Color(255, 255, 0));
        lbl_result_tipo.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_result_tipo.setText("usuario");
        getContentPane().add(lbl_result_tipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 10, -1, -1));

        lbl_bienvenido2.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        lbl_bienvenido2.setForeground(new java.awt.Color(255, 51, 51));
        lbl_bienvenido2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_bienvenido2.setText("Cerrar Sesión");
        getContentPane().add(lbl_bienvenido2, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 80, -1, -1));
        ...
        getContentPane().add(lbl_tipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 10, -1, -1));

        lbl_result_user.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        lbl_result_user.setForeground(new java.awt.Color(255, 255, 0));
        lbl_result_user.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_result_user.setText("usuario");
        getContentPane().add(lbl_result_user, new org.netbeans.lib.awtextra.AbsoluteConstraints(700, 10, -1, -1));

        lbl_user2.setBackground(new java.awt.Color(255, 255, 255));
        lbl_user2.setFont(new java.awt.Font("Verdana", 0, 12)); // NOI18N
        lbl_user2.setForeground(new java.awt.Color(255, 255, 255));
        lbl_user2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        lbl_user2.setText("Usuario:");
        getContentPane().add(lbl_user2, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 10, -1, -1));
        ...
        getContentPane().add(btn_ficha1, new org.netbeans.lib.awtextra.AbsoluteConstraints(530, 150, 140, 160));
        ...
        getContentPane().add(btn_buscar_membresia1, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 360, 170, 160));
        ...
        getContentPane().add(btn_rutina, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 150, 160, 160));

        jTextField1.setEditable(false);
        jTextField1.setBackground(new java.awt.Color(0, 0, 0));
        jTextField1.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        jTextField1.setCaretColor(new java.awt.Color(255, 255, 0));
        jTextField1.setDisabledTextColor(new java.awt.Color(255, 255, 51));
        jTextField1.setSelectedTextColor(new java.awt.Color(255, 255, 0));
        getContentPane().add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 900, 550));
        ...
        mnu_archivo.setForeground(new java.awt.Color(255, 255, 255));
        ...
        mnu_salir.setBackground(new java.awt.Color(255, 255, 51));
        mnu_salir.setFont(new java.awt.Font("Showcard Gothic", 0, 14)); // NOI18N
        ...
        mnu_clientes.setForeground(new java.awt.Color(255, 255, 255));
        ...
        mnu_cliente_nuevo.setBackground(new java.awt.Color(255, 255, 51));
        mnu_cliente_nuevo.setFont(new java.awt.Font("Showcard Gothic", 0, 14)); // NOI18N
        ...
        mnu_cliente_asistencia.setBackground(new java.awt.Color(255, 255, 51));
        mnu_cliente_asistencia.setFont(new java.awt.Font("Showcard Gothic", 0, 14)); // NOI18N
        ...
        mnu_cliente_modificar.setBackground(new java.awt.Color(255, 255, 51));
        mnu_cliente_modificar.setFont(new java.awt.Font("Showcard Gothic", 0, 14)); // NOI18N
        ...
        mnu_pagos.setForeground(new java.awt.Color(255, 255, 255));
        ...
        mnu_membresia.setForeground(new java.awt.Color(255, 255, 255));
        ...
        mnu_ficha.setForeground(new java.awt.Color(255, 255, 255));
        ...
        mnu_usuarios.setForeground(new java.awt.Color(255, 255, 255));
